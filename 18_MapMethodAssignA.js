...
const arratNumers = [20, 11, 40, 25, 23, 11, 9, 31, 60, 2, 19]
const arrayAdd = arratNumers.map( (element) => {
    return element+10;
} );
console.log(arrayAdd);

console.log("=========Square of each element=====================");
const arraySquar = arratNumers.map( (element) => {
    return element*element;
} );
console.log(arraySquar);

console.log("=========Adding index value in each element and log new array =====================");
const arrayIndex = arratNumers.map( (element, index) => {
